  ...
  return (
    <Modal title="Branch" onClose={onClose} dismissOnOverlay={false}>
      ...
      <div className={styles.formNote}>
        The read contract exposes no roster for a branch (no
        &quot;users/members of this branch&quot; list) and no delete — neither
        is invented here (recorded on issue #31 as contract follow-ups).
        Assignment visibility lives on the audit log and the assignment
        results below.
      </div>
